...
@section('content')
    ...
    {{ Form::open(['route' => 'applicantdata.store','class' => 'user', 'id' => 'pinfo', 'enctype' => 'multipart/form-data']) }}
    ...
    <div class="form-group row mb-3" id="training">
        <div class="col-sm-5 mb-3 mb-sm-0">
            ...
            {!! Form::text('tname', null, ['required', 'class' => 'form-control', 'placeholder' => 'Training Name', 'id' => 'tname']) !!}
        </div>
        <div class="col-sm-5 mb-3 mb-sm-0">
