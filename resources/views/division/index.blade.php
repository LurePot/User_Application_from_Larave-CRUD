...
<div class="card card-hover shadow mb-4">
    ...
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-info">Division List</h6>
        <a class="btn btn-sm btn-info btn-sm" href="{{url('division/create')}}">
                ...
                @foreach ($divisions as $division)
                    <tr>
                        ...
                        <td class="d-flex justify-content-between">
                            ...
                            {!! Form::close() !!}
                            <a href="{{url('division/'.$division->id.'/edit')}}" class="btn btn-sm btn-info btn-circle btn-sm" title="Edit">
                                Edit
                            </a>
